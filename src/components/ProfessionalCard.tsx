...
export default function ProfessionalCard({ professional }: ProfessionalCardProps) {
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {professional.availableDays.map((day) => (
                <span
                  key={day}
                  className="inline-block rounded-lg bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-700"
                >
                  {dayNames[day]}
                </span>
              ))}
